                    ...
                    <nav class="flex mt-1" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 text-xs text-slate-500 font-medium">
                            ...
                            <li><a href="{{ route('admin.menus.index') }}"
                                    class="hover:text-navy-600 transition-colors">Menu</a></li>
                            <li><span class="mx-1 text-slate-300">/</span></li>
        ...
        <div class="flex justify-center flex-grow">
            <div class="w-full max-w-4xl">
                ...
                <div
                    ...
                    <div
                        class="absolute top-0 right-0 -mt-16 -mr-16 w-64 h-64 bg-gradient-to-br from-navy-500/10 to-navy-500/10 rounded-full blur-3xl pointer-events-none">
                    </div>

                    <div class="px-8 py-6 border-b border-slate-100 flex items-center gap-4 bg-slate-50/50 relative z-10">
                        <div
                            class="w-12 h-12 rounded-2xl bg-navy-50 border border-navy-100 flex items-center justify-center text-navy-600 shadow-sm">
                        ...
                        <form action="{{ route('admin.menus.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2 md:col-span-2">
                                    ...
                                    <input type="text" name="name" required
                                        class="block w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-gold-500 focus:ring-gold-500 rounded-xl text-sm transition-all focus:bg-white focus:outline-none"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <select name="parent_id"
                                            class="block w-full px-4 py-3 pr-10 bg-slate-50 border border-slate-200 focus:border-gold-500 focus:ring-gold-500 rounded-xl text-sm transition-all focus:bg-white focus:outline-none appearance-none">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="route_name"
                                        class="block w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-gold-500 focus:ring-gold-500 rounded-xl text-sm transition-all focus:bg-white focus:outline-none font-mono"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-slate-400">Lihat referensi ikon di <a
                                            ...
                                            class="text-navy-500 hover:underline">feathericons.com</a>.</p>
                                </div>
                                ...
                                <div class="bg-navy-50/50 border border-navy-100 rounded-xl p-5">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                        @foreach($roles as $role)
                                            <div
                                                class="relative flex items-start p-3 border border-navy-100 bg-white rounded-lg hover:border-navy-300 transition-colors shadow-sm">
                            ...
                            <div class="flex items-center gap-3 pt-2">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <div
                                        class="w-11 h-6 bg-slate-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-gold-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-500 shadow-inner">
                                    </div>
                                </label>
                            ...
                            <div
                                ...
                                <a href="{{ route('admin.menus.index') }}"
                                    class="inline-flex justify-center items-center px-5 py-2.5 text-sm font-semibold text-slate-700 bg-white border border-slate-300 rounded-xl hover:bg-slate-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500 shadow-sm">
                                    Batal
                                </a>
                                <button type="submit"
                                    class="inline-flex justify-center items-center px-6 py-2.5 text-sm font-semibold text-white bg-navy-600 rounded-xl hover:bg-navy-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500 shadow-sm shadow-navy-600/20">
