    ...
    <div class="space-y-6 animate-fade-in">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                <a href="{{ route('admin.roles.index') }}" class="flex items-center justify-center w-10 h-10 rounded-xl bg-white border border-slate-200 text-slate-500 hover:text-indigo-600 hover:border-indigo-200 hover:bg-indigo-50 transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <nav class="flex mt-1" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 text-xs text-slate-500 font-medium">
                            ...
                            <li><a href="{{ route('admin.roles.index') }}" class="hover:text-indigo-600 transition-colors">Role</a></li>
                            <li><span class="mx-1 text-slate-300">/</span></li>
        ...
        <div class="flex justify-center">
            <div class="w-full max-w-4xl">
                ...
                <div class="bg-white border border-slate-100 rounded-3xl shadow-xl shadow-slate-200/40 overflow-hidden relative">
                    ...
                    <div class="absolute top-0 right-0 -mt-16 -mr-16 w-64 h-64 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 rounded-full blur-3xl pointer-events-none"></div>
                        ...
                        <form action="{{ route('admin.roles.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" id="name" name="name" 
                                    class="block w-full px-4 py-3 bg-slate-50 border @error('name') border-rose-300 ring-rose-300 @else border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 @enderror rounded-xl text-sm transition-all focus:bg-white focus:ring-2 focus:outline-none" 
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex rounded-xl shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 transition-all">
                                    ...
                                    <input type="text" id="slug" name="slug" 
                                        class="flex-1 block w-full min-w-0 px-4 py-3 rounded-none rounded-r-xl bg-slate-50 text-slate-700 font-mono text-sm border @error('slug') border-rose-300 focus:ring-rose-500 focus:border-rose-500 @else border-slate-200 focus:ring-indigo-500 focus:border-indigo-500 @enderror transition-all focus:bg-white focus:outline-none" 
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea id="description" name="description" rows="3" 
                                    class="block w-full px-4 py-3 bg-slate-50 border border-slate-200 @error('description') border-rose-300 ring-rose-300 @else hover:border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 @enderror rounded-xl text-sm transition-all focus:bg-white focus:ring-2 focus:outline-none resize-y" 
                            ...
                            <div class="pt-4 mt-6 border-t border-slate-100">
                                ...
                                <div class="bg-indigo-50/50 border border-indigo-100 rounded-2xl p-5">
                                    <p class="text-xs font-semibold text-indigo-800 mb-4 flex items-center gap-2 uppercase tracking-wide">
                                    ...
                                    <div class="flex flex-wrap gap-2.5">
                                        @foreach([
                                            ...
                                            <button type="button" 
                                                class="preset-btn inline-flex items-center px-3.5 py-1.5 rounded-full text-xs font-semibold bg-white border border-indigo-200 text-indigo-700 hover:bg-indigo-600 hover:text-white hover:border-indigo-600 transition-all shadow-sm transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1"
                                                data-name="{{ $preset }}" 
                                                data-desc="{{ $desc }}">
                                                {{ $preset }}
                                            </button>
                            ...
                            <div class="pt-6 mt-8 border-t border-slate-100 flex flex-col-reverse sm:flex-row justify-end gap-3">
                                <a href="{{ route('admin.roles.index') }}" class="inline-flex justify-center items-center px-5 py-2.5 text-sm font-semibold text-slate-700 bg-white border border-slate-300 rounded-xl hover:bg-slate-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-sm">
                                    Batal
                                </a>
                                <button type="submit" class="inline-flex justify-center items-center px-6 py-2.5 text-sm font-semibold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-sm shadow-indigo-600/20">
            ...
            document.querySelectorAll('.preset-btn').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    [nameInput, descriptionInput].forEach(el => {
                        ...
                        setTimeout(() => {
                            el.classList.remove('ring-2', 'ring-indigo-300', 'bg-indigo-50');
                        }, 500);
                    });
